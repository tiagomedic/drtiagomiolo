  ...
  ({ className, neon = true, size, variant, children, ...props }, ref) => {
    return (
      ...
      >
        <span
          className={cn(
            'absolute h-px opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out inset-x-0 inset-y-0 bg-gradient-to-r w-3/4 mx-auto from-transparent via-blue-400 to-transparent hidden',
            neon && 'block'
          )}
        />
        {children}
